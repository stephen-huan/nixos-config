...

{
  xsession.windowManager.i3 = {
    enable = true;
    config = {
      bars = [{ command = "i3status"; position = "top"; }];
    ...
    extraConfig = ''
      ...
      # gaps between outside border
      gaps outer 10

      # only enable gaps on a workspace when there is at more than one container
      smart_gaps on
      ...
      # same as smart gaps for borders
      smart_borders on
    '';
  };
}
